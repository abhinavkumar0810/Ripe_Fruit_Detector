...
def img_open_apple():
    global original
    filename = filedialog.askopenfilename(initialdir = 'D:/Final_Year_Project/Fruits/apple', title = 'Select an Image', filetypes = (('JPG','.jpg'),('All files','.*')))
...
def img_open_mango():
    global original
    filename = filedialog.askopenfilename(initialdir = 'D:/Final_Year_Project/Fruits/mango', title = 'Select an Image', filetypes = (('JPG','.jpg'),('All files','.*')))
    original = cv2.imread(filename)
    img = Image.open(filename)
    img = img.resize((500, 300), Image.ANTIALIAS)
    my_img = ImageTk.PhotoImage(img)
...
def img_open_orange():
    global original
    filename = filedialog.askopenfilename(initialdir = 'D:/Final_Year_Project/Fruits/orange', title = 'Select an Image', filetypes = (('JPG','.jpg'),('All files','.*')))
    original = cv2.imread(filename)
    img = Image.open(filename)
    img = img.resize((500, 300), Image.ANTIALIAS)
    my_img = ImageTk.PhotoImage(img)
...
def img_open_papaya():
    global original
    filename = filedialog.askopenfilename(initialdir = 'D:/Final_Year_Project/Fruits/papaya', title = 'Select an Image', filetypes = (('JPG','.jpg'),('All files','.*')))
    original = cv2.imread(filename)
    img = Image.open(filename)
    img = img.resize((500, 300), Image.ANTIALIAS)
    my_img = ImageTk.PhotoImage(img)
...
def img_open_banana():
    global original
    filename = filedialog.askopenfilename(initialdir = 'D:/Final_Year_Project/Fruits/banana', title = 'Select an Image', filetypes = (('JPG','.jpg'),('All files','.*')))
    original = cv2.imread(filename)  
    img = Image.open(filename)
    img = img.resize((500, 300), Image.ANTIALIAS)
    my_img = ImageTk.PhotoImage(img)
...
def apple_cam():
    ...
    while True:
        ...
        if k%256==27:
            ...
            file='D:/Final_Year_Project/Fruits/apple/img'+str(count)+'.jpg'
...
def banana_cam():
    ...
    while True:
        ...
        if k%256==27:
            ...
            print("Image "+str(count)+"saved")
            file='D:/Final_Year_Project/Fruits/banana/img'+str(count)+'.jpg'
            cv2.imwrite(file, img)
            count +=1
...
def mango_cam():
    ...
    while True:
        ...
        if k%256==27:
            ...
            print("Image "+str(count)+"saved")
            file='D:/Final_Year_Project/Fruits/mango/img'+str(count)+'.jpg'
            cv2.imwrite(file, img)
            count +=1
...
def orange_cam():
    ...
    while True:
        ...
        if k%256==27:
            ...
            print("Image "+str(count)+"saved")
            file='D:/Final_Year_Project/Fruits/orange/img'+str(count)+'.jpg'
            cv2.imwrite(file, img)
            count +=1
...
def papaya_cam():
    ...
    while True:
        ...
        if k%256==27:
            ...
            print("Image "+str(count)+"saved")
            file='D:/Final_Year_Project/Fruits/papaya/img'+str(count)+'.jpg'
            cv2.imwrite(file, img)
            count +=1
...
# Finction to select fruit from webcam
def webcam():
    if selected == 'Apple':
        apple_cam()
    elif selected == 'Mango':
...
label = tk.Label(canvas, text = 'Select the fruit', font = ('Times New Roman', '15'), bg = 'light pink')
...
open_img_btn = Button(canvas, text = "Choose an Image", bg='yellow' ,command = img_open)
open_img_btn.place(relx = 0.3, rely = 0.25, relwidth = 0.30, relheight = 0.05, anchor = CENTER)

open_cam_btn = Button(canvas, text = "open webcam", bg='yellow' ,command = webcam)
open_cam_btn.place(relx = 0.7, rely = 0.25, relwidth = 0.30, relheight = 0.05, anchor = CENTER)
